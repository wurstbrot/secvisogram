...
const additional_props = fs.readFileSync(
  new URL('config/additionalProperties.json', import.meta.url)
)
const meta_data2 = fs.readFileSync(
  new URL('config/metaData2.json', import.meta.url)
)
const csaf_json_schema = fs.readFileSync(
  new URL('schema_files/csaf_json_schema.json', import.meta.url),
  { encoding: 'utf-8' }
)
const cvss_v2_0_json = fs.readFileSync(
  new URL('schema_files/cvss-v2.0.json', import.meta.url),
  {
    encoding: 'utf-8',
  }
)
const cvss_v3_0_json = fs.readFileSync(
  new URL('schema_files/cvss-v3.0.json', import.meta.url),
  {
    encoding: 'utf-8',
  }
)
const cvss_v3_1_json = fs.readFileSync(
  new URL('schema_files/cvss-v3.1.json', import.meta.url),
  {
    encoding: 'utf-8',
  }
)
